...
class Fonts(object):
    ...
    attribute_map = {
        'mode': 'mode',
        'mask_glyphs': 'maskGlyphs',
        'families': 'families'
    }

    def __init__(self, mode=None, mask_glyphs=None, families=None, _configuration=None):  # noqa: E501
        """Fonts - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._mode = None
        self._mask_glyphs = None
        self._families = None
        self.discriminator = None

        self.mode = mode
        if mask_glyphs is not None:
    ...
    @property
    def mode(self):
        """Gets the mode of this Fonts.  # noqa: E501


        :return: The mode of this Fonts.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this Fonts.


        :param mode: The mode of this Fonts.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mask_glyphs(self):
        """Gets the mask_glyphs of this Fonts.  # noqa: E501


        :return: The mask_glyphs of this Fonts.  # noqa: E501
        :rtype: bool
        """
        return self._mask_glyphs

    @mask_glyphs.setter
    def mask_glyphs(self, mask_glyphs):
        """Sets the mask_glyphs of this Fonts.


        :param mask_glyphs: The mask_glyphs of this Fonts.  # noqa: E501
        :type: bool
        """

        self._mask_glyphs = mask_glyphs

    @property
    def families(self):
        """Gets the families of this Fonts.  # noqa: E501


        :return: The families of this Fonts.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def families(self, families):
        """Sets the families of this Fonts.


        :param families: The families of this Fonts.  # noqa: E501
        :type: list[str]
        """
