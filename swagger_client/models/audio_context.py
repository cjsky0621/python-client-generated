...
class AudioContext(object):
    ...
    def __init__(self, mode=None, _configuration=None):  # noqa: E501
        """AudioContext - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def mode(self):
        """Gets the mode of this AudioContext.  # noqa: E501


        :return: The mode of this AudioContext.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this AudioContext.


        :param mode: The mode of this AudioContext.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and mode is None:
            raise ValueError("Invalid value for `mode`, must not be `None`")  # noqa: E501
        allowed_values = ["REAL", "NOISE"]  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AudioContext, dict):
