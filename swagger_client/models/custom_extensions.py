...
class CustomExtensions(object):
    ...
    def __init__(self, enable=None, names=None, _configuration=None):  # noqa: E501
        """CustomExtensions - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def enable(self):
        """Gets the enable of this CustomExtensions.  # noqa: E501


        :return: The enable of this CustomExtensions.  # noqa: E501
        :rtype: bool
        """
        return self._enable
    ...
    def enable(self, enable):
        """Sets the enable of this CustomExtensions.


        :param enable: The enable of this CustomExtensions.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def names(self):
        """Gets the names of this CustomExtensions.  # noqa: E501

        Extension filenames ending in .crx (Mimic) or .xpi (Stealthfox) passed as an array.  # noqa: E501

        :return: The names of this CustomExtensions.  # noqa: E501
        :rtype: list[str]
        """
        return self._names
    ...
    def names(self, names):
        """Sets the names of this CustomExtensions.

        Extension filenames ending in .crx (Mimic) or .xpi (Stealthfox) passed as an array.  # noqa: E501

        :param names: The names of this CustomExtensions.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomExtensions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomExtensions):
            return False
