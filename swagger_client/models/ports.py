...
class Ports(object):
    ...
    swagger_types = {
        'mode': 'str',
        'local_ports_exclude': 'list[int]'
    }

    attribute_map = {
        'mode': 'mode',
        'local_ports_exclude': 'localPortsExclude'
    }

    def __init__(self, mode=None, local_ports_exclude=None, _configuration=None):  # noqa: E501
        ...
        self._mode = None
        self._local_ports_exclude = None
        self.discriminator = None

        self.mode = mode
        if local_ports_exclude is not None:
            self.local_ports_exclude = local_ports_exclude

    @property
    def mode(self):
        """Gets the mode of this Ports.  # noqa: E501


        :return: The mode of this Ports.  # noqa: E501
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        """Sets the mode of this Ports.


        :param mode: The mode of this Ports.  # noqa: E501
        :type: str
        """
    ...
    @property
    def local_ports_exclude(self):
        """Gets the local_ports_exclude of this Ports.  # noqa: E501

        Ports that are excluded from port scanning detection. If REAL mode selected then this must be null.  # noqa: E501

        :return: The local_ports_exclude of this Ports.  # noqa: E501
        :rtype: list[int]
        """
        return self._local_ports_exclude

    @local_ports_exclude.setter
    def local_ports_exclude(self, local_ports_exclude):
        """Sets the local_ports_exclude of this Ports.

        Ports that are excluded from port scanning detection. If REAL mode selected then this must be null.  # noqa: E501

        :param local_ports_exclude: The local_ports_exclude of this Ports.  # noqa: E501
        :type: list[int]
        """

        self._local_ports_exclude = local_ports_exclude
